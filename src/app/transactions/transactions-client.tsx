...
export const TransactionsClient: React.FC<TransactionsClientProps> = ({
  ...
  const filteredData = useMemo(
    () =>
      data
        .filter((item) => {
          ...
          const typeMatch =
            typeFilter === "all" ||
            item.type === (typeFilter === "income" ? "Income" : "Expense");
          const categoryMatch =
    ...
    [data, filter, typeFilter, categoryFilter]
  );
  ...
  const columns = useMemo(
    () => getColumns(handleEdit, handleDeleteRequest, categories, accounts),
    [categories, accounts, onTransactionChange]
  );
      ...
      <AlertDialog open={isAlertOpen} onOpenChange={setIsAlertOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              esto eliminara la transaccion. Esta accion es completamente
              irreversible.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
